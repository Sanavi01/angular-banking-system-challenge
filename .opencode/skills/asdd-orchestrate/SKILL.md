...
description: Orquesta el flujo ASDD completo. Fase 1 (Spec) → Fase 2 (Frontend) → Fase 3 (Tests) → Fase 4 (QA).
...
[FASE 3 — TESTS]
  test-engineer-frontend  → pruebas unitarias Jest
...
2. Lanza Fase 2 (frontend-developer)
3. Cuando Fase 2 completa → lanza Fase 3 (test-engineer-frontend)
